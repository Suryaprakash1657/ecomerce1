...
const handleImage = (e) =>{
    ...
    setPreImage((prev)=>[...prev,...imagePreview]);
}
...
return(
    <div>
        ...
        <form>
            ...
            <input type="number" value={stock} onChange={(e)=>setStock(e.target.price)} required/>
            </div>
             <label className="pb-1 block">
                Upload Images <span className="text-red-500">*</span>
             </label>
             <input type="file" id="upload" onChange={handleImage} required multiple accept ='.jpg .png .jepg' />
             <div>
